...
<body>
<h1>This is Optin TY Page</h1>
</body>

<!-- GL MAIN -->
<script type="text/javascript">
var _gl_client = '50'; // don't change
var _gl_page_type = 'optin_thankyou'; // page type one of (salesletter, optin, optin_thankyou, sales_thankyou, upsell, blog, content, order, landing, checkout)
var _gl_labels = []; // array of labels  
var _gl_optin = '<?=rawurldecode($_GET['email'])?>'; // put email value if this is optin track 
var _gl_amount = null; // put amount of product if this is sale track
...
var _gl_sale_code = null; // this field will be used to distinguish different orders inside of deduplication algorithm
var _gl_product_code = null; // name or code of the product
...
<h3>Thanks for optin <?=rawurldecode($_GET['email'])?></h3>
</html>